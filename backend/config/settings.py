...
SECRET_KEY = 'django-insecure-@u(94_p3c6j3hy^$1h#87c(^l2nt+t_hyehhvm5$-c4@e+r^3f'
...
INSTALLED_APPS = [
    ...
    # --- Mis aplicaciones ---
    'api.apps.ApiConfig',  # Registra la app 'api' que creamos
]

MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware',  # Poner al inicio
...
'default': {
        ...
        'NAME': 'san_rafael_db',         # El nombre de la DB que creamos
...
# Orígenes (dominios) que tienen permiso de hacer peticiones
...
# ==============================================================================
# CONFIGURACIÓN DE MEDIA (Para subir imágenes de productos)
# ==============================================================================
MEDIA_URL = '/media/'
...
# ==============================================================================
# Para Desarrollo (Imprime el correo en la consola de Django, no manda email real)
